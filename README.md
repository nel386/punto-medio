...
El flujo de agentes, ámbitos de escritura, dependencias y formato de entregas está definido en `orchestration/`. La app carga los 20 lotes editoriales versionados desde `content/categories/`; `content/catalog.json` conserva el catálogo inicial agregado.
