...
- El recorrido del target y la aguja se extiende simétricamente a `±82.5°` para que 0 y 100 queden quince grados más inclinados que el recorrido inicial y a ras de la tapa celeste; la conversión del puntero usa la misma escala.
- La fan de puntuación se recorta en una ventana fija que representa la abertura física: al girar hacia un extremo puede ocultar sectores laterales, pero conserva el 4 central y al menos tres puntuaciones visibles.
