...
- El recorrido del target y la aguja se extiende simétricamente a `±77.5°` para que 0 y 100 queden diez grados más inclinados que el recorrido inicial y a ras de la tapa celeste; la conversión del puntero usa la misma escala.
